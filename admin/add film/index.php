        ...
        <form action="" class="inputBox" method="post">
            <div>
                <textarea name="title" class="feedback" id="feedback" cols="30" rows="1" required
                    placeholder="   اسم القيلم   "></textarea>
            </div>
            <div>
            ...
            <div>
                <textarea name="link" class="feedback" id="feedback" cols="30" rows="1" required
                    placeholder=" رابط القيلم  "></textarea>
            </div>
            <div>
                <textarea name="download" class="feedback" id="feedback" cols="30" rows="3" required
            ...
            <div>
                <textarea name="icon" class="feedback" id="feedback" cols="30" rows="3" required
                    placeholder="   رابط الصورة   "></textarea>
            </div>
            <div>
                <textarea name="description" class="feedback" id="feedback" cols="30" rows="3" required
...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO episode (title, episode, type) VALUES ('$title','$episode','$type')";
    ...
    $query2 = "INSERT INTO server (episode_id, link, episode, server_name, download) VALUES ('$inserted_id','$link','$title','$server_name','$download')";
    ...
    $query3 = "INSERT INTO type (name, type, icon, description) VALUES ('$title','$type','$icon','$description')";
